...
- **Не публикуйте свои события в `bus`** — шина предназначена для
  системных событий навбара. Локальные взаимодействия между вашими
  компонентами делайте через React Context / props / refs.
...
- [ ] Нет публикации своих событий в `bus`
