...
export function useNavbarState({
   ...
   * Ручной tablet-выбор (`slim`/`standard`), персистируемый между роутами.
   *
   * Запоминается в обработчике `toggle:request` (useNavbarToggle) на tablet. Используется:
   ...
   * от провайдера. Используется в обработчике `toggle:request` (автоскролл на /home)
